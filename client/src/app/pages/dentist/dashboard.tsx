      ...
      <main className="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
        <div className="px-4 py-6 sm:px-0">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center">👥 Patients</CardTitle>
                <CardDescription>Gestion de votre patientèle</CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-sm text-gray-600 mb-4">
                  Intelligence artificielle alimentée par vos données patients.
                </p>
                <Button variant="outline" className="w-full" disabled>
                  À venir - Phase 2
                </Button>
            ...
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center">📅 Planning</CardTitle>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Tableau de bord analytique</CardDescription>
              </CardHeader>
              <CardContent>
                <p className="text-sm text-gray-600 mb-4">
