  ...
  if (showSuccess) {
    return (
      <div className="text-center py-8">
        ...
        <Button onClick={onSuccess} className="bg-[hsl(221,83%,53%)] hover:bg-[hsl(221,83%,48%)] text-white">
          Fermer
        </Button>
      </div>
    );
  ...
  if (showError) {
    return (
      <div className="text-center py-8">
        ...
        <Button onClick={resetForm} className="bg-[hsl(221,83%,53%)] hover:bg-[hsl(221,83%,48%)] text-white">
          Réessayer
        </Button>
      </div>
    );
