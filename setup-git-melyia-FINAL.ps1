# Script: setup-git-melyia-FINAL.ps1
...
Write-Host ""
Write-Host "Creation script de statut..." -ForegroundColor Yellow

# Script de statut simplifie
$statusContent = @'
...
$statusContent | Out-File -FilePath "status.ps1" -Encoding UTF8
...
Write-Host "README et documentation crees" -ForegroundColor White
